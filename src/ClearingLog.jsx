      ...
      <div style={sectionStyle}>
        ...
        {expandedSections['ROW & Boundaries'] && (
          <div style={contentStyle}>
            <div style={gridStyle}>
              <div><label style={labelStyle}>Design ROW Width (m)</label><input type="number" value={clearingData.rowBoundaries?.rowWidthDesign || ''} onChange={(e) => updateField('rowBoundaries', 'rowWidthDesign', e.target.value)} placeholder="Per route sheets" style={inputStyle} /></div>
              <div><label style={labelStyle}>Actual ROW Width (m)</label><input type="number" value={clearingData.rowBoundaries?.rowWidthActual || ''} onChange={(e) => updateField('rowBoundaries', 'rowWidthActual', e.target.value)} placeholder="Field measured" style={inputStyle} /></div>
              ...
              (clearingData.timberDecks || []).map((deck, idx) => (
                <div key={idx} style={{ marginBottom: '15px', padding: '15px', backgroundColor: idx % 2 === 0 ? '#f8f9fa' : '#fff', borderRadius: '6px', border: '1px solid #dee2e6' }}>
                  ...
                  <div style={gridStyle}>
                    ...
                    <div><label style={labelStyle}>Start KP</label><input type="number" step="0.001" value={deck.startKp || ''} onChange={(e) => updateTimberDeck(idx, 'startKp', e.target.value)} style={inputStyle} /></div>
                    <div><label style={labelStyle}>End KP</label><input type="number" step="0.001" value={deck.endKp || ''} onChange={(e) => updateTimberDeck(idx, 'endKp', e.target.value)} style={inputStyle} /></div>
                    ...
                    <div><label style={labelStyle}>Min Top Diameter (cm)</label><input type="number" value={deck.minTopDiameter || ''} onChange={(e) => updateTimberDeck(idx, 'minTopDiameter', e.target.value)} style={inputStyle} /></div>
                    ...
                    <div><label style={labelStyle}>Volume Estimate (m³)</label><input type="number" value={deck.volumeEstimate || ''} onChange={(e) => updateTimberDeck(idx, 'volumeEstimate', e.target.value)} style={inputStyle} /></div>
                  </div>
                </div>
              ))
            )}
        ...
        {expandedSections['Grubbing & Stripping'] && (
          <div style={contentStyle}>
            <div style={gridStyle}>
              ...
              <div><label style={labelStyle}>Max Stump Height (cm)</label><input type="number" value={clearingData.grubbingStripping?.stumpHeightMax || ''} onChange={(e) => updateField('grubbingStripping', 'stumpHeightMax', e.target.value)} placeholder="Spec ≤15cm" style={inputStyle} /></div>
        ...
        {expandedSections['Temp Fencing'] && (
          <div style={contentStyle}>
            <div style={gridStyle}>
              ...
              <div><label style={labelStyle}>Fencing Length (m)</label><input type="number" value={clearingData.tempFencing?.tempFencingLength || ''} onChange={(e) => updateField('tempFencing', 'tempFencingLength', e.target.value)} placeholder="Total meters" style={inputStyle} /></div>
              ...
              <div><label style={labelStyle}>Number of Gates</label><input type="number" value={clearingData.tempFencing?.gatesCount || ''} onChange={(e) => updateField('tempFencing', 'gatesCount', e.target.value)} style={inputStyle} /></div>
            </div>
          </div>
        )}
      </div>
