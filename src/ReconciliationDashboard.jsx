    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f3f4f6', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ backgroundColor: 'white', padding: '12px 24px', borderBottom: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', gap: '20px' }}>
        <div style={{ display: 'flex', gap: '8px' }}>
          ...
          <button onClick={() => setViewMode('lemReconciliation')} style={{ padding: '8px 16px', borderRadius: '6px', border: 'none', cursor: 'pointer', backgroundColor: viewMode === 'lemReconciliation' ? '#b45309' : '#e5e7eb', color: viewMode === 'lemReconciliation' ? 'white' : '#374151', fontWeight: '500' }}>
            📋 Contractor LEMs
          </button>
        </div>
