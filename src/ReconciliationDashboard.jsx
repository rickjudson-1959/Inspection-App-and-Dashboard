            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              ...
              <tbody>
                {filteredItems.length === 0 ? (
                  <tr><td colSpan={7 + (trackableTypeFilter === 'all' ? 1 : 0) + extraCols.length} style={{ padding: '40px', textAlign: 'center', color: '#9ca3af' }}>
                  ...
                  filteredItems.map((item, idx) => {
                    ...
                    return (
                      <tr key={item.id} style={{ borderBottom: '1px solid #e5e7eb', backgroundColor: idx % 2 === 0 ? 'white' : '#f9fafb' }}>
                        ...
                        <td style={{ padding: '12px', fontSize: '12px' }}>{item.inspector_name || '-'}</td>
