            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan="9" style={{ padding: '40px', textAlign: 'center', color: '#9ca3af' }}>No LEMs found</td></tr>
                ) : (
                  filteredBillingLems.map(lem => {
                    ...
                    return (
                      <tr key={lem.id} style={{ borderBottom: '1px solid #e5e7eb', backgroundColor: isSelected ? '#f0fdf4' : 'white' }}>
                        ...
                        <td style={{ padding: '12px', textAlign: 'right', fontFamily: 'monospace' }}>${labour.toLocaleString()}</td>
                        <td style={{ padding: '12px', textAlign: 'right', fontFamily: 'monospace' }}>${equip.toLocaleString()}</td>
                        <td style={{ padding: '12px', textAlign: 'right', fontFamily: 'monospace', fontWeight: 'bold', color: '#059669' }}>${total.toLocaleString()}</td>
                        <td style={{ padding: '12px', textAlign: 'center' }}>
                          <span style={{ backgroundColor: colors.bg, color: colors.text, padding: '4px 12px', borderRadius: '12px', fontSize: '11px', fontWeight: '500' }}>
                            {colors.label}
                          </span>
                        </td>
                        <td style={{ padding: '12px', fontFamily: 'monospace', color: '#6b7280' }}>{lem.invoice_number || '-'}</td>
                      </tr>
                    )
                  })
                )}
              ...
              {filteredBillingLems.length > 0 && (
                <tfoot>
                  <tr style={{ backgroundColor: '#f9fafb', fontWeight: 'bold' }}>
                    ...
                    <td style={{ padding: '12px', textAlign: 'right', fontFamily: 'monospace', color: '#059669', fontSize: '16px' }}>
