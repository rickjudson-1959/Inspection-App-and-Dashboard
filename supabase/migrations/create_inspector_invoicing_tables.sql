-- Inspector Invoicing System Database Schema
-- This creates tables for managing inspector timesheets, profiles, and invoicing
-- Use this for FRESH installations. For updates to existing tables, use reset_inspector_invoicing_tables.sql
...
-- Policies (use DROP IF EXISTS to avoid errors)
DO $$ BEGIN
...
-- INSPECTOR DOCUMENTS
-- =====================================================
CREATE TABLE IF NOT EXISTS inspector_documents (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- =====================================================
CREATE TABLE IF NOT EXISTS inspector_rate_cards (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  inspector_profile_id UUID REFERENCES inspector_profiles(id) ON DELETE CASCADE,
...
-- =====================================================
CREATE TABLE IF NOT EXISTS inspector_timesheets (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  inspector_profile_id UUID REFERENCES inspector_profiles(id) ON DELETE CASCADE,
...
-- =====================================================
CREATE TABLE IF NOT EXISTS inspector_timesheet_lines (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- =====================================================
CREATE INDEX IF NOT EXISTS idx_inspector_profiles_user_id ON inspector_profiles(user_id);
CREATE INDEX IF NOT EXISTS idx_inspector_documents_profile_id ON inspector_documents(inspector_profile_id);
CREATE INDEX IF NOT EXISTS idx_inspector_documents_expiry ON inspector_documents(expiry_date);
CREATE INDEX IF NOT EXISTS idx_inspector_timesheets_profile_id ON inspector_timesheets(inspector_profile_id);
CREATE INDEX IF NOT EXISTS idx_inspector_timesheets_status ON inspector_timesheets(status);
CREATE INDEX IF NOT EXISTS idx_inspector_timesheets_period ON inspector_timesheets(period_start, period_end);
CREATE INDEX IF NOT EXISTS idx_inspector_timesheet_lines_timesheet_id ON inspector_timesheet_lines(timesheet_id);
CREATE INDEX IF NOT EXISTS idx_inspector_timesheet_lines_date ON inspector_timesheet_lines(work_date);
CREATE INDEX IF NOT EXISTS idx_inspector_rate_cards_profile_id ON inspector_rate_cards(inspector_profile_id);
