-- Add monthly rate, base rate, and parts allowance breakdown columns to equipment_rates
ALTER TABLE equipment_rates ADD COLUMN IF NOT EXISTS rate_monthly NUMERIC(10,2) DEFAULT 0;
